...
const Faq = () => {
  ...
  return KontenFaq.map((konten, index) => {
    // var isi = konten.isi;
    return (
      <div key={index} className="flex flex-col accordion">
        <div className="accordion-faq flex flex-row px-3 lg:px-6 py-[10px] items-center cursor-pointer bg-primary rounded-[8px] justify-between w-full">
          ...
          <span className="fill-text2 transition-all ease-in-out duration-200">
        ...
        <div className="content-accordion h-0 px-6 w-full bg-secondary text-text2 rounded-[8px] text-paragraph2res md:px-10 md:text-paragraph2 overflow-hidden transition-all ease-in-out duration-200">
